...
import Headericon from 'assets/letterr.png';
    ...
    <header className={styles.navbar} ref={headerRef}>
      <RouterLink href={route === '/' ? '/#intro' : '/'} scroll={false}>
        <a
          ...
          aria-label="Ravindra Nakrani, Dev."
          onClick={handleMobileNavClick}
        >
          {/* <Monogram highlight /> */}
          {/* <image src={Headericon}/> */}
          <img src='https://res.cloudinary.com/dn2mupqo0/image/upload/v1657101846/letter-r_t9vwaq.png' height={50}/>
          {/* <Image srcSet={Headericon}/> */}
        </a>
      </RouterLink>
